...
class DoctorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stats = [
    'total' => Doctor::count(),
    'active' => Doctor::whereHas('staff', function ($q) { $q->where('status', 'Active'); })->count(),
    'inactive' => Doctor::whereHas('staff', function ($q) { $q->where('status', 'Inactive');})->count(),
              ];

        return view('doctor.index', compact('doctors','staffs', 'departments', 'stats'));
    }
/*
    // Show Create Form
    ...
    public function store(Request $request)
{
    ...
    'consultation_fee' => 'numeric|required',
        ]);
       $doctor= Doctor::create([
        ...
        'consultation_fee'=>$data1['consultation_fee']
        ]);
