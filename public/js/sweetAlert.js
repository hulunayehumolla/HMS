...
! function(t, e) {
    ...
    var v = {},
        g = function(t) {
            return new Promise((function(e) {
                ...
                v.restoreFocusTimeout = setTimeout((function() {
                    v.previousActiveElement instanceof HTMLElement ? (v.previousActiveElement.focus(), v.previousActiveElement = null) : document.body && document.body.focus(), e()
        ...
        wt = function(t) {
            var e, n = !!(e = O()) && (e.remove(), rt([document.documentElement, document.body], [y["no-backdrop"], y["toast-shown"], y["has-column"]]), !0);
            if (gt()) E("SweetAlert2 requires document to initialize");
                ...
                p.appendChild(o),
                    ...
                    }(p), r = I(), a = at(r, y.input), c = at(r, y.file), u = r.querySelector(".".concat(y.range, " input")), s = r.querySelector(".".concat(y.range, " output")), l = at(r, y.select), d = r.querySelector(".".concat(y.checkbox, " input")), f = at(r, y.textarea), a.oninput = yt, c.onchange = yt, l.onchange = yt, d.onchange = yt, f.oninput = yt, u.oninput = function() {
                        yt(), s.value = u.value
                    }, u.onchange = function() {
                        yt(), s.value = u.value
                    }
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? ut(n) : st(n), tt(n, e, "actions"), function(t, e, n) {
                ...
                Pt(o, "confirm", n), Pt(i, "deny", n), Pt(r, "cancel", n),
                    function(t, e, n, o) {
                        ...
                        it([t, e, n], y.styled), o.confirmButtonColor && (t.style.backgroundColor = o.confirmButtonColor, it(t, y["default-outline"]));
                        o.denyButtonColor && (e.style.backgroundColor = o.denyButtonColor, it(e, y["default-outline"]));
                        o.cancelButtonColor && (n.style.backgroundColor = o.cancelButtonColor, it(n, y["default-outline"]))
    ...
    function Pt(t, e, n) {
        var o = A(e);
        ft(t, n["show".concat(o, "Button")], "inline-block"), G(t, n["".concat(e, "ButtonText")] || ""), t.setAttribute("aria-label", n["".concat(e, "ButtonAriaLabel")] || ""), t.className = y[e], tt(t, n, "".concat(e, "Button"))
    }
    var Tt = function(t, e) {
        var n = O();
        n && (! function(t, e) {
            ...
            if (!e) return;
            e in y ? it(t, y[e]) : (k('The "position" parameter is not valid, defaulting to "center"'), it(t, y.center))
            ...
            if ("MutationObserver" in window) {
                ...
                new MutationObserver((function() {
                    if (document.body.contains(t)) {
                        var o, i = t.offsetWidth + (o = t, parseInt(window.getComputedStyle(o).marginLeft) + parseInt(window.getComputedStyle(o).marginRight));
    ...
    var Vt = function(t, e) {
        ...
        zt = function(t, e) {
            var n = e.showClass || {};
            t.className = "".concat(y.popup, " ").concat(pt(t) ? n.popup : ""), e.toast ? (it([document.documentElement, document.body], y["toast-shown"]), it(t, y.toast)) : it(t, y.modal), tt(t, e, "popup"), "string" == typeof e.customClass && it(t, e.customClass), e.icon && it(t, y["icon-".concat(e.icon)])
        },
        Kt = function(t) {
        ...
        Wt = function(t) {
            var e = document.createElement("li");
            return it(e, y["progress-step-line"]), t.progressStepsDistance && ct(e, "width", t.progressStepsDistance), e
        },
        Yt = function(t, e) {
            ! function(t, e) {
                var n = O(),
                ...
                function(t, e) {
                    ...
                    if (n) {
                        ...
                        o && 0 !== o.length && void 0 !== i ? (ut(n), n.textContent = "", i >= o.length && k("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.forEach((function(t, r) {
                            var a = Kt(t);
                            if (n.appendChild(a), r === i && it(a, y["active-progress-step"]), r !== o.length - 1) {
                                var c = Wt(e);
                                n.appendChild(c)
                            }
                        }))) : st(n)
                ...
                function(t, e) {
                    var n = V();
                    n && (e.imageUrl ? (ut(n, ""), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt || ""), ct(n, "width", e.imageWidth), ct(n, "height", e.imageHeight), n.className = y.image, tt(n, e, "image")) : st(n))
                }(0, e),
                function(t, e) {
                    var n = D();
    ...
    function me(t, e, n, o) {
        X() ? Ae(t, o) : (g(n).then((function() {
            return Ae(t, o)
        })), Jt(v)), ce ? (e.setAttribute("style", "display:none !important"), e.removeAttribute("class"), e.innerHTML = "") : e.remove(), J() && (null !== fe && (document.body.style.paddingRight = "".concat(fe, "px"), fe = null), function() {
            if (Q(document.body, y.iosfix)) {
                var t = parseInt(document.body.style.top, 10);
                rt(document.body, y.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t
            }
        }(), ae()), rt([document.documentElement, document.body], [y.shown, y["height-auto"], y["no-backdrop"], y["toast-shown"]])
    }
    ...
    var be = function(t) {
        ...
        Ce = function(t, e, n, o, i) {
            Et && (v.swalCloseEventFinishedCallback = me.bind(null, t, n, o, i), e.addEventListener(Et, (function(t) {
                t.target === e && (v.swalCloseEventFinishedCallback(), delete v.swalCloseEventFinishedCallback)
            })))
        },
        Ae = function(t, e) {
            setTimeout((function() {
        ...
        Ee = function(t, e) {
            var n = K(),
                o = z();
            n && o && (!e && pt(N()) && (e = N()), ut(n), e && (st(e), o.setAttribute("data-button-to-replace", e.className), n.insertBefore(o, e)), it([t, n], y.loading))
        },
        Be = function(t) {
                ...
                var o = function(t) {
                    "select" === e.input ? function(t, e, n) {
                        ...
                        e.forEach((function(t) {
                            ...
                            r.type = "radio", r.name = y.radio, r.value = e, Oe(e, n.inputValue) && (r.checked = !0);
                            var c = document.createElement("span");
                            G(c, i), c.className = y.label, a.appendChild(r), a.appendChild(c), o.appendChild(a)
                        }));
    ...
    var Le = function t(e) {
        ...
        He = function(t, e) {
            ...
            (n.showLoaderOnDeny && ke(U()), n.preDeny) ? (t.isAwaitingPromise = !0, Promise.resolve().then((function() {
                ...
                !1 === n ? (t.hideLoading(), be(t)) : t.close({
                    isDenied: !0,
                    value: void 0 === n ? e : n
                })
            })).catch((function(e) {
        ...
        Ve = function(t, e) {
            ...
            (n.showLoaderOnConfirm && ke(), n.preConfirm) ? (t.resetValidationMessage(), t.isAwaitingPromise = !0, Promise.resolve().then((function() {
                ...
                pt(R()) || !1 === n ? (t.hideLoading(), be(t)) : De(t, void 0 === n ? e : n)
            })).catch((function(e) {
                return qe(t || je, e)
            }))) : De(t, e)
        };
    ...
    function _e() {
        ...
        if (t) {
            ...
            st(e.loader), X() ? t.icon && ut(H()) : Re(e), rt([e.popup, e.actions], y.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.denyButton.disabled = !1, e.cancelButton.disabled = !1
        }
    }
    var Re = function(t) {
    ...
    function Ue(t, e) {
        ...
        if (n && t)
            if ("radio" === t.type)
                for (var o = n.querySelectorAll('[name="'.concat(y.radio, '"]')), i = 0; i < o.length; i++) o[i].disabled = e;
            else t.disabled = e
    }
    ...
    function Ze(t) {
        ...
        G(e.validationMessage, t), e.validationMessage.className = y["validation-message"], n.customClass && n.customClass.validationMessage && it(e.validationMessage, n.customClass.validationMessage), ut(e.validationMessage);
        var o = this.getInput();
        o && (o.setAttribute("aria-invalid", "true"), o.setAttribute("aria-describedby", y["validation-message"]), nt(o), it(o, y.inputerror))
    }
    ...
    function $e() {
        ...
        var e = this.getInput();
        e && (e.removeAttribute("aria-invalid"), e.removeAttribute("aria-describedby"), rt(e, y.inputerror))
    }
    var Je = {
            title: "",
            titleText: "",
    ...
    function sn() {
        ...
        e ? (t.popup && v.swalCloseEventFinishedCallback && (v.swalCloseEventFinishedCallback(), delete v.swalCloseEventFinishedCallback), "function" == typeof e.didDestroy && e.didDestroy(), ln(this)) : dn(this)
    }
    var ln = function(t) {
            dn(t), delete t.params, delete v.keydownHandler, delete v.keydownTarget, delete v.currentInstance
        },
        dn = function(t) {
        ...
        gn = function(t) {
            t.popup.onmousedown = function() {
                t.container.onmouseup = function(e) {
                    t.container.onmouseup = function() {}, e.target === t.container && (vn = !0)
                }
            }
        },
        bn = function(t) {
            t.container.onmousedown = function(e) {
                e.target === t.container && e.preventDefault(), t.popup.onmouseup = function(e) {
                    t.popup.onmouseup = function() {}, (e.target === t.popup || e.target instanceof HTMLElement && t.popup.contains(e.target)) && (vn = !0)
                }
            }
        },
        yn = function(t, e, n) {
    ...
    var Bn, Pn = function(t) {
        ...
        jn = function(t) {
            ...
            return Array.from(t.querySelectorAll("swal-button")).forEach((function(t) {
                ...
                e["".concat(n, "ButtonText")] = t.innerHTML, e["show".concat(A(n), "Button")] = !0, t.hasAttribute("color") && (e["".concat(n, "ButtonColor")] = t.getAttribute("color")), t.hasAttribute("aria-label") && (e["".concat(n, "ButtonAriaLabel")] = t.getAttribute("aria-label"))
            })), e
        },
        Mn = function(t) {
            var e = {},
        ...
        _n = function(t) {
            ...
            }()), X() || v.previousActiveElement || (v.previousActiveElement = document.activeElement), "function" == typeof t.didOpen && setTimeout((function() {
                return t.didOpen(n)
        ...
        Nn = function(t, e) {
            Et && ht(e) ? (t.style.overflowY = "hidden", e.addEventListener(Et, Rn)) : t.style.overflowY = "auto"
        },
        Fn = function(t, e, n) {
            ! function() {
                if (ce && !Q(document.body, y.iosfix)) {
                    var t = document.body.scrollTop;
                    document.body.style.top = "".concat(-1 * t, "px"), it(document.body, y.iosfix), ue()
                }
        ...
        Un = function(t, e, n) {
            ...
            }), 10)) : ut(e, "grid"), it([document.documentElement, document.body], y.shown), n.heightAuto && n.backdrop && !n.toast && it([document.documentElement, document.body], y["height-auto"])
        },
        zn = {
            email: function(t, e) {
    ...
    var Wn = new WeakMap,
            ...
            return a((function t() {
                ...
                value: function(t) {
                    ...
                    if (function(t) {
                        ...
                        }(Object.assign({}, e, t)), v.currentInstance) {
                        var n = re.swalPromiseResolve.get(v.currentInstance),
                            o = v.currentInstance.isAwaitingPromise;
                        v.currentInstance._destroy(), o || n({
                            isDismissed: !0
                        }), J() && ae()
                    }
                    v.currentInstance = Bn;
                    var i = $n(t, e);
                    Kn(i), Object.freeze(i), v.timeout && (v.timeout.stop(), delete v.timeout), clearTimeout(v.restoreFocusTimeout);
                    var r = Jn(Bn);
                ...
                re.swalPromiseResolve.set(t, o), re.swalPromiseReject.set(t, i), e.confirmButton.onclick = function() {
                    ...
                    function(t, e, n) {
                        Jt(t), e.toast || (t.keydownHandler = function(t) {
                            return te(e, t, n)
                        }, t.keydownTarget = e.keydownListenerCapture ? window : I(), t.keydownListenerCapture = e.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
                            capture: t.keydownListenerCapture
                    ...
                    }(t, n), _n(n), Xn(v, n, r), Gn(e, n), setTimeout((function() {
        ...
        $n = function(t, e) {
            ...
            return o.showClass = Object.assign({}, Je.showClass, o.showClass), o.hideClass = Object.assign({}, Je.hideClass, o.hideClass), !1 === o.animation && (o.showClass = {
    ...
    })), Yn.DismissReason = $t, Yn.version = "11.12.2";
    var io = Yn;
