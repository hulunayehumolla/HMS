...
! function(t, e) {
	...
	function pt(t, e, i) {
		...
		if (t._sorted) {
			const {
				...
				vScale: l,
				_parsed: h
			} = t, c = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null, d = r.axis, {
				min: u,
				max: f,
				minDefined: g,
				maxDefined: p
	...
	function ji(t, e, i, n) {
		const {
			...
			data: a,
			_sorted: r
		} = t, l = o._cachedMeta.iScale, h = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null;
			...
			if (!n) {
				...
				if (h) {
					const {
						...
						_parsed: i
					} = t, a = i.slice(0, n.lo + 1).reverse().findIndex((t => !s(t[e.axis])));
					n.lo -= Math.max(0, a);
	...
	class tn extends $s {
		...
		_computeLabelSizes(t, e, i) {
			const {
				ctx: o,
				_longestTextCache: a
			} = this, r = [], l = [], h = Math.floor(e / qs(e, i));
	...
	class Tn {
		...
		buildOrUpdateControllers() {
			...
			for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
				...
				if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || ln(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
				else {
	...
	var Un = Object.freeze({
		...
		BarController: class extends js {
			...
			_calculateBarValuePixels(t) {
				...
				} = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = Bn(h);
				let d, u, f = l[e.axis],
					g = 0,
		...
		BarElement: class extends $s {
			...
			draw(t) {
				const {
					...
					inner: n,
					outer: o
				} = ho(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? He : uo;
				var r;
	...
	var Jo = {
		...
		beforeLayout(t, e, i) {
			...
			const {
				...
				elements: o
			} = n, a = Go(s) || (r = n) && (r.borderColor || r.backgroundColor) || o && Go(o) || "rgba(0,0,0,0.1)" !== ue.borderColor || "rgba(0,0,0,0.1)" !== ue.backgroundColor;
			var r;
	...
	function ga(t, e, i) {
		...
		for (const r of s) {
			...
			o ? (t.moveTo(h.x, h.y), o = !1) : (t.lineTo(i, h.y), t.lineTo(h.x, h.y)), a = !!e.pathSegment(t, r, {
				move: a
	...
	class ya extends $s {
		...
		_draw() {
			...
			const {
				...
				boxHeight: p,
				itemHeight: m
			} = _a(o, d), x = this.isHorizontal(), b = this._computeTitleHeight();
			f = x ? {
	...
	class Wa extends $s {
		...
		getTitle(t, e) {
			const {
				callbacks: i
			} = e, s = Ba(i, "beforeTitle", this, t), n = Ba(i, "title", this, t), o = Ba(i, "afterTitle", this, t);
			let a = [];
		...
		getFooter(t, e) {
			const {
				callbacks: i
			} = e, s = Ba(i, "beforeFooter", this, t), n = Ba(i, "footer", this, t), o = Ba(i, "afterFooter", this, t);
			let a = [];
			return a = Ca(a, Oa(s)), a = Ca(a, Oa(n)), a = Ca(a, Oa(o)), a
		}
		_createItems(t) {
		...
		_positionChanged(t, e) {
			const {
				...
				caretY: s,
				options: n
			} = this, o = Da[n.position].call(this, t, e);
	...
	return Tn.register(Un, $o, go, t), Tn.helpers = {
		...Hi
	}, Tn._adapters = In, Tn.Animation = As, Tn.Animations = Ts, Tn.animator = bt, Tn.controllers = nn.controllers.items, Tn.DatasetController = js, Tn.Element = $s, Tn.elements = go, Tn.Interaction = Ki, Tn.layouts = ls, Tn.platforms = Ds, Tn.Scale = tn, Tn.Ticks = ae, Object.assign(Tn, Un, $o, go, t, Ds), Tn.Chart = Tn, "undefined" != typeof window && (window.Chart = Tn), Tn
}));
