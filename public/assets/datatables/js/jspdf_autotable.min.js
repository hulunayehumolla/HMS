        ...
        var e = {
                ...
                259: function(t, e, n) {
                    ...
                    e.parseCss = function(t, e, n, i, l) {
                        ...
                        var g = ["left", "right", "center", "justify"]; - 1 !== g.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (g = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
                ...
                587: function(t, e, n) {
                    ...
                    e.parseInput = function(t, e) {
                        ...
                        var f = function(t, e, n) {
                            ...
                            p = function(t, e) {
                                var n, o, r, l, a, s, u, d, h, c, f, g, p, y = (0, i.parseSpacing)(e.margin, 40 / t.scaleFactor()),
                ...
                189: function(t, e, n) {
                    ...
                    e.calculateWidths = function(t, e) {
                        ...
                        s && (s = i(n, s, (function(t) {
                                ...
                                return t.minWidth
                            }))), s = Math.abs(s), !e.settings.horizontalPageBreak && s > .1 / t.scaleFactor() && (s = s < 1 ? s : Math.round(s), console.error("Of the table content, ".concat(s, " units width could not fit page"))),
                            function(t) {
                                ...
                                for (var n = {
                                    ...
                                    for (var i = r[o], a = 0, s = t.columns; a < s.length; a++) {
                                        ...
                                        if (d) {
                                            ...
                                            else if ("ellipsize" === d.styles.overflow) d.text = l(d.text, h, d.styles, e, "...");
                                            else if ("hidden" === d.styles.overflow) d.text = l(d.text, h, d.styles, e, "");
