...
<div class="container-fluid">
    ...
    <div class="row g-3 mb-4">
        @php
            $cards = [
                ['label'=>'Total Nurse','value'=>$stats['total'],'icon'=>'fa-users','bg'=>'bg-dark text-white'],
                ['label'=>'Active Nurse','value'=>$stats['active'],'icon'=>'fa-user-check','bg'=>'bg-success text-white'],
                ['label'=>'Inactive Nurse','value'=>$stats['inactive'],'icon'=>'fa-user-xmark','bg'=>'bg-danger text-white'],
            ];
        @endphp
        ...
        <ul class="nav nav-tabs mb-3" id="staffTab" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#personal">
                    <i class="fa-solid fa-users me-1"></i> View Nurse
                </button>
            </li>
            <li class="nav-item">
            ...
            <div class="tab-content">
                ...
                <form id="staffForm" action="{{ route('nurse.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<div class="card mt-3">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <label class="form-label">Ward Assigned</label>
                <input type="number" step="0.01" name="ward_assigned"
                       value="{{ old('ward_assigned') }}"
                       class="form-control">
            </div>
            ...
            <div class="col-md-4">
                ...
                <div id="photoPreviewContainer" class="mt-2"></div>
                    ...
                    <div class="mt-3 text-end">
                        <a href="{{ route('nurse.index') }}" class="btn btn-secondary btn-sm">Cancel</a>
                        <button type="submit" class="btn btn-success  saveBtn btn-sm">Save Staff</button>
                    </div>
                </form>
                </div>
                ...
                <div class="tab-pane show active fade" id="personal">
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        <div class="card-body bg-light rounded">
                            <form action="{{ route('nurse.index') }}" method="GET" class="row g-2 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('nurse.index') }}" class="btn btn-outline-secondary w-100">
