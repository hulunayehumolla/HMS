...
<div class="container-fluid">
    ...
    <div class="row g-3 mb-4">
        @php
            $cards = [
                ['label'=>'Total Doctor','value'=>$stats['total'],'icon'=>'fa-users','bg'=>'bg-dark text-white'],
                ['label'=>'Active Doctor','value'=>$stats['active'],'icon'=>'fa-user-check','bg'=>'bg-success text-white'],
                ['label'=>'Inactive Doctor','value'=>$stats['inactive'],'icon'=>'fa-user-xmark','bg'=>'bg-danger text-white'],
            ];
        @endphp
        ...
        <ul class="nav nav-tabs mb-3" id="staffTab" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#personal">
                    <i class="fa-solid fa-users me-1"></i> View Doctor
                </button>
            </li>
            <li class="nav-item">
            ...
            <div class="tab-content">
                ...
                <form id="staffForm" action="{{ route('doctor.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-md-4">
                ...
                <div id="photoPreviewContainer" class="mt-2"></div>
                    ...
                    <div class="mt-3 text-end">
                        <a href="{{ route('doctor.index') }}" class="btn btn-secondary btn-sm">Cancel</a>
                ...
                <div class="tab-pane show active fade" id="personal">
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        <div class="card-body bg-light rounded">
                            <form action="{{ route('doctor.index') }}" method="GET" class="row g-2 align-items-end">
                                <div class="col-md-3">
                    ...
                    <table class="table table-bordered table-hover align-middle" id="staffTable">
                        ...
                        <tbody>
                            ...
                            <tr id="staffRow{{ $s->id }}">
                                ...
                                <td>{{ $s->doctor_id ?? '-' }}</td>
                                <td>{{ $s->staff->first_name ?? '-'}} {{ $s->staff->first_name ?? '-'}} {{ $s->staff->middle_name  ?? '-'}}</td>
