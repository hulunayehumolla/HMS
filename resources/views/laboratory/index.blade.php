        ...
        <ul class="nav nav-tabs mb-3" id="staffTab" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#personal">
                    <i class="fa-solid fa-pills me-1"></i> View Laboratory
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#employment">
                    <i class="fa-solid fa-user-plus me-1"></i> Add Laboratory
                </button>
            </li>
        </ul>
            ...
            <div class="tab-content">
                ...
                <form id="staffForm" action="{{ route('laboratory.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-3 text-end">
                        <a href="{{ route('laboratory.index') }}" class="btn btn-secondary btn-sm">Cancel</a>
                        <button type="submit" class="btn btn-success  saveBtn btn-sm">Save Laboratory</button>
                    </div>
                </form>
                </div>
                ...
                <div class="tab-pane show active fade" id="personal">
                    ...
                    <div class="card mb-4 border-0 shadow-sm">
                        <div class="card-body bg-light rounded">
                            <form action="{{ route('laboratory.index') }}" method="GET" class="row g-2 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('laboratory.index') }}" class="btn btn-outline-secondary w-100">
